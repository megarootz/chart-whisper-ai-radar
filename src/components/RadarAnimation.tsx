...
const RadarAnimation = ({ isOpen = true }) => {
  ...
  return (
    <Dialog open={isOpen}>
      <DialogContent className="bg-gray-950 border-2 border-blue-500/30 backdrop-blur-xl p-0 sm:max-w-5xl max-w-[98vw] max-h-[98vh] overflow-hidden shadow-2xl shadow-blue-500/20">
        <div className="relative w-full min-h-[600px] sm:min-h-[700px] lg:min-h-[800px] flex flex-col items-center justify-center bg-gray-950 p-4 sm:p-6 lg:p-8">
