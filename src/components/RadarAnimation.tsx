      ...
      <DialogContent className="bg-chart-card border-gray-700 p-8 sm:max-w-md max-w-[95vw]">
        <div className="flex flex-col items-center w-full max-w-md mx-auto">
          <div className="relative w-40 h-40 md:w-60 md:h-60">
            ...
            >
              <div className="h-1/2 w-1.5 bg-gradient-to-t from-primary to-transparent mx-auto"></div>
              <div className="w-20 h-20 md:w-30 md:h-30 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-40 rounded-full"
                  style={{
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <Radar size={42} className="text-primary animate-pulse" />
            </div>
          </div>
          ...
          <h3 className="text-white font-medium text-xl mt-6">Analyzing Chart</h3>
