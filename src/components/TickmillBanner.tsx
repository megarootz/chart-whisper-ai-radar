...
const TickmillBanner = () => {
  return <div className="bg-chart-card border border-gray-700 rounded-lg p-4 md:p-6 overflow-hidden relative">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <Button className="shrink-0 bg-primary hover:bg-primary/90 transition-colors shadow-lg shadow-primary/20" onClick={() => window.open('https://tickmill.link/42ZXbEB', '_blank')}>
