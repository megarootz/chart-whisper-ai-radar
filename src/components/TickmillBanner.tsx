...
const TickmillBanner = () => {
  return (
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 border border-gray-700 rounded-lg p-5 md:p-6 shadow-md overflow-hidden relative">
      <div className="flex flex-col md:flex-row items-center justify-between gap-5">
        ...
        <Button 
          className="shrink-0 bg-primary hover:bg-primary/90 transition-all shadow-lg shadow-primary/20"
          size="lg"
