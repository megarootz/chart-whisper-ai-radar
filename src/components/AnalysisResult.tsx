...
import { TrendingUp, TrendingDown, CircleArrowDown, CircleArrowUp, ChartCandlestick, Download } from 'lucide-react';
                  ...
                  {data.priceLevels.map((level, index) => (
                    <tr key={index} className="border-b border-gray-700 bg-gray-800/30">
                      <td className="px-4 py-3 font-medium text-white flex items-center gap-2">
                        <span className={level.name.startsWith('R') ? "text-bearish" : "text-bullish"}>•</span> 
                        {level.name}
                      </td>
