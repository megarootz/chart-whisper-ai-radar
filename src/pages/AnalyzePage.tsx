...
import { Cloud, Upload, Info, AlertCircle, ExternalLink } from 'lucide-react';
              ...
              <div className="space-y-4">
                <div className="bg-blue-900/20 border border-blue-800/50 rounded-lg p-3 md:p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-blue-400 font-medium text-sm md:text-base mb-1">Full-Screen Chart Analysis</h4>
                      <p className="text-gray-400 text-xs md:text-sm mb-3">
                        Use our dedicated full-screen chart page for the most accurate live analysis. The larger display ensures complete data capture with TradingView's native screenshot feature.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  Open Full-Screen Chart for Live Analysis
                </Button>
              </div>
            </div>
          </div>
              ...
              <div className="bg-chart-card border border-gray-700 rounded-lg p-4 md:p-6">
                ...
                <div className="flex flex-col items-center justify-center py-12 md:py-16">
                  ...
                  <p className="text-gray-400 text-center text-sm md:text-base max-w-md">
                    Use live chart analysis or upload a chart image to get detailed technical analysis
                  </p>
                </div>
              </div>
            )}
