...
const AnalyzePage = () => {
  ...
  const handleAutoAnalyze = (capturedFile: File, symbol: string, timeframe: string) => {
    if (!user) {
      console.log("User not logged in, cannot analyze chart");
      return;
    }
    
    console.log("Starting automated chart analysis...", { symbol, timeframe });
    analyzeChart(capturedFile, symbol, timeframe);
  };
        ...
        <div className={`${isMobile ? 'w-full' : 'container mx-auto max-w-6xl'}`}>
          ...
          <Tabs defaultValue="automated" className="mb-6">
            <TabsList className="grid w-full grid-cols-2 bg-gray-800 border-gray-700">
              <TabsTrigger value="automated" className="data-[state=active]:bg-primary">
                Automated Analysis
              </TabsTrigger>
              ...
              <div className="bg-chart-card border border-gray-700 rounded-lg p-4 md:p-6">
                ...
                <div className="flex flex-col items-center justify-center py-12 md:py-16">
                  ...
                  <p className="text-gray-400 text-center text-sm md:text-base max-w-md">
                    Use automated analysis or upload a chart image to get detailed technical analysis
                  </p>
                </div>
              </div>
            )}
