          ...
          <div className="bg-chart-card border border-gray-700 rounded-lg p-6 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-2 border-dashed border-gray-700 rounded-lg flex flex-col items-center justify-center p-8 transition-colors cursor-pointer hover:border-primary" onClick={() => document.getElementById('file-upload')?.click()}>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-black rounded-lg border border-gray-800 h-72 flex items-center justify-center">
                  {previewUrl ? <img src={previewUrl} alt="Chart Preview" className="max-h-full max-w-full object-contain" /> : <div className="text-center p-6">
